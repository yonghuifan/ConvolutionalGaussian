function [GPLmkIdx,ptuq] = GetGPLmk_Euclidean(G,numLmk)
...
fullPhi = sparse(repmat(1:G.nV,1,BNN+1),idx,exp(-dist.^2/(bandwidth*2)),G.nV,G.nV);
fullMatProd = (fullPhi+fullPhi')/2;
